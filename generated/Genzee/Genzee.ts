...
export class Genzee extends ethereum.SmartContract {
  static bind(address: Address): Genzee {
    return new Genzee("Genzee", address);
  }
  ...
  TOTAL_TOKENS(): BigInt {
    let result = super.call("TOTAL_TOKENS", "TOTAL_TOKENS():(uint256)", []);

    return result[0].toBigInt();
  }

  try_TOTAL_TOKENS(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("TOTAL_TOKENS", "TOTAL_TOKENS():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  allGenzeesOfWallet(owner: Address): Array<BigInt> {
    let result = super.call(
      "allGenzeesOfWallet",
      "allGenzeesOfWallet(address):(uint256[])",
  ...
  try_allGenzeesOfWallet(owner: Address): ethereum.CallResult<Array<BigInt>> {
    let result = super.tryCall(
      "allGenzeesOfWallet",
      "allGenzeesOfWallet(address):(uint256[])",
      [ethereum.Value.fromAddress(owner)]
  ...
  reservedsLeft(): BigInt {
    let result = super.call("reservedsLeft", "reservedsLeft():(uint256)", []);

    return result[0].toBigInt();
  }

  try_reservedsLeft(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "reservedsLeft",
      "reservedsLeft():(uint256)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  tokensLeft(): BigInt {
    let result = super.call("tokensLeft", "tokensLeft():(uint256)", []);

    return result[0].toBigInt();
  }

  try_tokensLeft(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("tokensLeft", "tokensLeft():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  totalSupplyMinusReserved(): BigInt {
    let result = super.call(
      "totalSupplyMinusReserved",
      "totalSupplyMinusReserved():(uint256)",
      []
    );
  ...
  try_totalSupplyMinusReserved(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "totalSupplyMinusReserved",
      "totalSupplyMinusReserved():(uint256)",
      []
  ...
  tripleUnitPrice(): BigInt {
    let result = super.call(
      "tripleUnitPrice",
      "tripleUnitPrice():(uint256)",
      []
    );
  ...
  try_tripleUnitPrice(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "tripleUnitPrice",
      "tripleUnitPrice():(uint256)",
      []
  ...
  unitPrice(): BigInt {
    let result = super.call("unitPrice", "unitPrice():(uint256)", []);

    return result[0].toBigInt();
  }

  try_unitPrice(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("unitPrice", "unitPrice():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class MintOneGenzeeCall extends ethereum.Call {
  get inputs(): MintOneGenzeeCall__Inputs {
    return new MintOneGenzeeCall__Inputs(this);
  }

  get outputs(): MintOneGenzeeCall__Outputs {
    return new MintOneGenzeeCall__Outputs(this);
  }
}

export class MintOneGenzeeCall__Inputs {
  _call: MintOneGenzeeCall;

  constructor(call: MintOneGenzeeCall) {
    this._call = call;
  }
}

export class MintOneGenzeeCall__Outputs {
  _call: MintOneGenzeeCall;
...
export class MintThreeGenzeeCall extends ethereum.Call {
  get inputs(): MintThreeGenzeeCall__Inputs {
    return new MintThreeGenzeeCall__Inputs(this);
  }

  get outputs(): MintThreeGenzeeCall__Outputs {
    return new MintThreeGenzeeCall__Outputs(this);
  }
}

export class MintThreeGenzeeCall__Inputs {
  _call: MintThreeGenzeeCall;

  constructor(call: MintThreeGenzeeCall) {
    this._call = call;
  }
}

export class MintThreeGenzeeCall__Outputs {
  _call: MintThreeGenzeeCall;
...
export class UpdatePriceCall__Inputs {
  ...
  get newUnitPrice(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }

  get newTripleUnitPrice(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }
}
